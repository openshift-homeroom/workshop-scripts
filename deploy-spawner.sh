...
if [ x"$SPAWNER_MODE" == x"learning-portal" ]; then
    TEMPLATE_ARGS="$TEMPLATE_ARGS --param HOMEROOM_NAME=$HOMEROOM_NAME"
    TEMPLATE_ARGS="$TEMPLATE_ARGS --param WORKSHOP_TITLE='$WORKSHOP_TITLE'"
    TEMPLATE_ARGS="$TEMPLATE_ARGS --param WORKSHOP_DESCRIPTION='$WORKSHOP_DESCRIPTION'"
    TEMPLATE_ARGS="$TEMPLATE_ARGS --param SPAWNER_ROLE=$SPAWNER_ROLE"
    TEMPLATE_ARGS="$TEMPLATE_ARGS --param SPAWNER_PASSWORD=$SPAWNER_PASSWORD"
